...
public class Order {
    ...
    public void SubTotal() {
        System.out.println("Menghitung sub total");
    }
    ...
    public void Total() {
        ...
        System.out.println("Menghitung jumlah total keseluruhan");
    }

    public void TotalWeight() {
        System.out.println("Menghitung berat");
    }

    // Menggunkan for untuk araylist
    public void infoOrderan() {

        for (String s : Arrays.asList("\n" + "Customer : " + dataCustomer.getName(),
                "Alamat   : " + dataCustomer.getAlamat(), "Tanggal  : " + date, "Status   : " + status + "\n")) {
    ...
    /*
     * karena pada Customer ini menggunakan asosiasi saya tidak membuat object pada
     * constructor,
